...
@testset "StandardDist{Uniform}" begin
    ...
    @testset "StandardDist{Uniform,0}" begin
        ...
        @test @inferred(truncated(StandardDist{Uniform}(), -0.5f0, 0.7f0)) isa
              Uniform{Float64}
        ...
        @test @inferred(product_distribution(fill(StandardDist{Uniform}(), 3))) isa
              DistributionMeasures.StandardDist{Uniform,1}
        @test product_distribution(fill(StandardDist{Uniform}(), 3)) ==
              DistributionMeasures.StandardDist{Uniform}(3)
    end
