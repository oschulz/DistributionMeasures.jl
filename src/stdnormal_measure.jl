...
@inline MeasureBase.vartransform_def(::StdUniform, μ::StdNormal, x) = StatsFuns.normcdf(checked_var(μ, x))
@inline MeasureBase.vartransform_def(::StdNormal, μ::StdUniform, x) = StatsFuns.norminvcdf(checked_var(μ, x))
